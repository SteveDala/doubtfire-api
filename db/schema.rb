...
ActiveRecord::Schema[7.1].define(version: 2024_05_28_223908) do
  ...
  create_table "project_convenors", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.integer "unit_id"
    t.integer "user_id"
  ...
  create_table "task_templates", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.integer "unit_id"
    t.string "name"
    t.string "description"
    t.decimal "weighting", precision: 10
    ...
    t.datetime "updated_at", precision: nil
    t.string "abbreviation"
    t.index ["unit_id"], name: "index_task_templates_on_unit_id"
  end
  ...
  create_table "team_memberships", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "team_id"
  ...
  create_table "teams", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.integer "unit_id"
    t.integer "user_id"
